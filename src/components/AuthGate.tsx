...
const AuthGate = ({ onComplete, onSkip }: AuthGateProps) => {
  ...
  return (
    ...
    >
      <div className="max-w-[85%] space-y-4">
        <div className="bg-ai-bubble rounded-2xl rounded-tl-sm shadow-sm px-5 py-4">
          <p
            className="text-foreground text-[15px] leading-relaxed mb-4"
            style={{ lineHeight: "1.8" }}
          >
            Vuoi che ti ricordi? Così la prossima volta riprendo da dove ci siamo fermati.
          </p>
