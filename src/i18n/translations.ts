...
const translations = {
  it: {
    ...
    landing_disclaimer: "Clauria ascolta, accompagna, aiuta a fare chiarezza e a custodire la gioia. Non sostituisce un medico, uno psicologo o una guida spirituale.",
    landing_cta: "Inizia",
  ...
  en: {
    ...
    landing_disclaimer: "Clauria listens, accompanies, helps bring clarity, and cherishes joy. It does not replace a doctor, a psychologist, or a spiritual guide.",
    landing_cta: "Start",
