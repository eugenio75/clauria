...
const translations = {
  it: {
    ...
    landing_disclaimer: "Clauria ascolta, accompagna, aiuta a fare chiarezza e a custodire la gioia. Non sostituisce le relazioni umane — le rafforza e le rende possibili. Non sostituisce uno psicologo o una guida spirituale.",
    landing_cta: "Inizia",
  ...
  en: {
    ...
    landing_disclaimer: "Clauria listens, accompanies, helps bring clarity and cherish joy. It does not replace human relationships — it strengthens them and makes them possible. It does not replace a psychologist or a spiritual guide.",
    landing_cta: "Start",
    landing_about: "About",
